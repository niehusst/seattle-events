# Data Model: Seattle Events Web Application
...
- A composite unique constraint should exist on (title, startDate, locationName) to prevent duplicates

### Relationships
- None (Event is a standalone entity)

## SourceWebsite Entity
