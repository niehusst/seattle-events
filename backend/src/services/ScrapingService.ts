...
export class ScrapingService {
  ...
  private parseEvents(html: string, website: ISourceWebsite): IEventPartial[] {
    const events: IEventPartial[] = [];
    ...
    for (const selector of eventSelectors) {
      $(selector).each((index, element) => {
        ...
        // Create event object
        const event: IEventPartial = {
          title,
          description,
          startDate,
          endDate: startDate, // TODO: Not always available in listings
